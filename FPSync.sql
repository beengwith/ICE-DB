...
INSERT INTO @NewFPEntries
    ...
    WHERE
        ...
        AND (SENSORID = 101 OR SENSORID = 103)
        AND (SENSORID = 102) -- this condition is there to disable reading from zkt
...
WHILE @@FETCH_STATUS=0 BEGIN
    ...
    BEGIN
        ...
        PRINT @date + ' ' + @time + ' ' + cast(@tid as char) + ' ' + cast(@uid as char);
        EXEC dbo.RecordFingerPrintEntry @uid, @tid, @date, @time;
